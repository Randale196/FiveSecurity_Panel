...
$fetchData = fetch_data($link, $tableName, $columns);

function fetch_data($link, $tableName, $columns) {
  if (empty($link)) {
    ...
    $stmt = mysqli_prepare($link, "SELECT * FROM `keys` ORDER by licenseid DESC limit ?");
    $limit = 150;
...
<head>
    ...
    <title><?php echo $website_config['site_name']; ?> | Key Overview</title>
        ...
        <div class="sidebar" id="sidebar">
            ...
            <nav class="sidebar-nav">
                ...
                <div class="nav-section">
                    ...
                    <div class="nav-item">
                        <a href="https://<?php echo $website_config['site_domain']; ?>/admin/auth/overview" class="nav-link active">
        ...
        <div class="main-content">
            ...
            <div class="header">
                <div style="display: flex; align-items: center; gap: 1rem;">
                    ...
                    <div class="header-title">Key Overview</div>
                </div>
            ...
            <div class="content-area">
                ...
                <div class="keys-table-card">
                    <div class="card-header">
                        ...
                        <a href="https://<?php echo $website_config['site_domain']; ?>/admin/auth/keygenerator" class="btn btn-primary">
                    ...
                    <div class="table-responsive">
                        <table class="table">
                            <caption>List of all unused Keys</caption>
                            <thead>
                                <tr>
                                    <th>ID</th>
                                    <th>License</th>
                            ...
                            <tbody>
                                ...
                                ?>
                                <tr>
                                    <td><?php echo $data['licenseid']??''; ?></td>
                                    <td>
                                        <span class="key-license" onclick="copyToClipboard('<?php echo $data['license']??''; ?>')" title="Click to copy">
                                    ...
                                    <td>
                                        ...
                                        $expire = $data['expire']??'';
                                        if ($expire == 'lifetime') {
                                            echo '<span class="expire-lifetime">Lifetime</span>';
                                        } elseif ($expire == 'partner') {
                                            echo '<span class="expire-partner">Partner</span>';
                                        } else {
                                            echo '<span class="expire-date">' . htmlspecialchars($expire) . '</span>';
                                        }
                                        ?>
                                    </td>
                                </tr>
